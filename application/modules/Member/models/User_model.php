...
//        echo $this->db->last_query();
    ...
    public function upgrade_update_directs($user_id) {
        $this->db->set('upgrade_directs', 'upgrade_directs + 1', FALSE);
        $this->db->where('user_id', $user_id);
        $this->db->update('tbl_users');
    }
    ...
    public function upgrade_total_team_update($id) {
        $this->db->set('upgrade_total_user_after_paid', 'upgrade_total_user_after_paid + 1', FALSE);
        $this->db->where(['paid_status' => 1, 'upgrade_status' => 1]);
        $this->db->update('tbl_users');
    }
...
//        echo $this->db->last_query();
    ...
    public function checkRoiLevel2(){
        $this->db->select('user_id,created_at');
        $this->db->from('tbl_roi');
        $this->db->where(array('days' => 0));
        $this->db->group_by('user_id');
        $query = $this->db->get();
