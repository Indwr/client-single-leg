                ...
                <ul class="clearfix">
                    <li>
                        <div class="member-img">
                            <a href="<?php echo base_url('Member/Profile/Tree/' . $user['user_id']); ?>">
                        ...
                        <ul class="clearfix">
                            ...
                            foreach ($users as $key => $direct) {
                                ...
                                <li>
                                    <div class="member-img">
                                        <a href="<?php echo base_url('Member/Profile/Tree/' . $direct['user_id']); ?>">
                                    ...
                                    <ul class="clearfix">
                                        ...
                                        foreach ($direct['sub_directs'] as $k => $sub_direct) {
                                            ...
                                            <li>
                                                <div class="member-img">
                                                    <a href="<?php echo base_url('Member/Profile/Tree/' . $sub_direct['user_id']); ?>">
