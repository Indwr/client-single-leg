  ...
  <!--Start sidebar-wrapper-->
   ...
   <!-- <div class="user-details">
    <div class="media align-items-center user-pointer collapsed" data-toggle="collapse" data-target="#user-dropdown">
       ...
       <h6 class="side-user-name"><?php //echo strtoupper($user_info['name']);?></h6>
      </div>
       </div>
     <div id="user-dropdown" class="collapse">
      <ul class="user-setting-menu">
            <li><a href="<?php //echo base_url('Member/Profile/index');?>"><i class="icon-user"></i>  My Profile</a></li>
      <li><a href="<?php //echo base_url('Member/Management/logout');?>"><i class="icon-power"></i> Logout</a></li>
      </ul>
     </div>
      </div> -->
   <ul class="sidebar-menu do-nicescrol">
      ...
      <li>
       ...
       <i class="fa fa-angle-left pull-right"></i>
        ...
        <ul class="sidebar-submenu">
            ...
            <!-- <li><a href="<?php //echo base_url('Member/Downline/checkLeadership');?>"><i class="fa fa-long-arrow-right"></i> Check Leadership</a></li> -->
        </ul>
      </li>
      ...
      <!-- <li>
       ...
       <i class="fa fa-angle-left pull-right"></i>
        ...
        <ul class="sidebar-submenu">
            <li><a href="<?php // echo base_url('Member/Epin/AvailebleEpin');?>"><i class="fa fa-long-arrow-right"></i>Account Activation</a></li>
        </ul>
      </li> -->
      <li>
        <a href="javaScript:void();" class="waves-effect">
     ...
     <!--  <li>
       ...
       <i class="fa fa-angle-left pull-right"></i>
        ...
        <ul class="sidebar-submenu">
            <li><a href="<?php //echo base_url('Member/Downline/royaltyAchiver_list');?>"><i class="fa fa-long-arrow-right"></i>Royalty Achivers</a></li>
        </ul>
        <ul class="sidebar-submenu">
            <li><a href="<?php //echo base_url('Member/Downline/leadershipAchiver_list');?>"><i class="fa fa-long-arrow-right"></i>Leadership Achivers</a></li>
        </ul>
      </li> -->
