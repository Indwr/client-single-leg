...
<script>
    function show_messages() {
        ...
        $.get('<?php echo base_url("Jarvis/Support/user_messages/") ?>' + user_id, function (res) {
            var html = '';
    ...
    function send_message() {
        var url = '<?php echo base_url('Jarvis/Support/SubmitQuery'); ?>';
        var formData = {
    ...
    function show_users() {
        var url = '<?php echo base_url("Jarvis/Support/show_users") ?>';
        var html = '';
