        ...
        <div class="col-md-6">
            <div class="kt-portlet kt-portlet--mobile">
                <div class="kt-portlet">
                    ...
                    <?php echo form_open(base_url('Jarvis/Management/promo_code/')); ?>
                        ...
                        <div class="kt-widget4">
                            ...
                            foreach ($promo_codes as $code) {
                                ...
                                <div class="kt-widget4__item">
                                    ...
                                    <a href="<?php echo base_url('Jarvis/Management/delete_promo_code/' . $code['id']); ?>" class="btn btn-sm btn-bold"><i class="fa fa-trash"></i></a>
                                </div>
                                <?php
                            }
                            ?>
