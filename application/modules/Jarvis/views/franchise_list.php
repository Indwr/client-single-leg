            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        <a class="btn btn-default" href="<?php echo base_url('Jarvis/Franchise/AddFranchise');?>">Create New</a>
                    </div>
                  </div>
                </form>
              </div>
                        ...
                        foreach ($franchises as $key => $franchise) {
                            ...
                            <tr>
                                ...
                                <td><?php echo $franchise['pin_code']; ?></td>
                                 <td>
                                  <a href="<?php echo base_url('Jarvis/Franchise/Delete/'.$franchise['id']);?>" target="_blank">Delete</a>/
                                </td>
                            </tr>
                            <?php
                            $i++;
