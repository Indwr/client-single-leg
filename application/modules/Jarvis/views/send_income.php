  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Send Income</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item">Fund Management</li>
              <li class="breadcrumb-item active">Send Income (FAILD WITHDRAW)</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="form-group">
                            ...
                            <a href="<?php echo base_url('Jarvis/Settings/sendIncomeOtp')?>" class="btn btn-success btn-sm">Get OTP</a>
            </div>
            <div class="form-group">
