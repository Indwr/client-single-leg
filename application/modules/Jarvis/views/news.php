          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <a href="<?php echo base_url('Jarvis/Settings/CreateNews');?>" class="btn btn-success">Create New</a>   
              </div>
              <!-- /.card-header -->
                    ...
                    <?php
                        foreach ($news as $key => $new) {
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo base_url('Jarvis/Settings/newsDelete/'.$new['id']);?>" target="_blank">Delete</a></td>
                            </tr>
                            <?php
                        }
                        ?>
