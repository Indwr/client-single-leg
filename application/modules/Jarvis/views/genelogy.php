            ...
            <div class="dropdown">
                ...
                <div class="span">
                    <span id="ctl00_ContentPlaceHolder1_lblusername1">
                        <a href="<?php echo base_url('Jarvis/Management/Genelogy/' . $level1->user_id); ?>"><?php echo $level1->first_name . ' ' . $level1->last_name; ?></a>
                    </span>
                    <br>
                ...
                if (!empty($l2)) {
                    ...
                    <div class="row_2_child">
                        <div class="dropdown">
                            ...
                            <div class="span">
                                <span id="">
                                    <a href="<?php echo base_url('Jarvis/Management/Genelogy/' . $l2->user_id); ?>"><?php echo $l2->first_name . ' ' . $l2->last_name ?></a>
                                </span>
                                <br>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="span">
                                <span id="ctl00_ContentPlaceHolder1_lblusername4">
                                    <a href="<?php echo base_url('Jarvis/Management/Genelogy/' . $l3->user_id); ?>"><?php echo $l3->first_name . ' ' . $l3->last_name; ?></a> </span><br>
