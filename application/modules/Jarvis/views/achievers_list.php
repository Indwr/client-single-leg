        ...
        <div class="row">
          <div class="col-12">
            ...
            <!-- </div> -->
              ...
              <a class="btn btn-default" href="<?php echo base_url('Jarvis/Achievers/AddAchiever');?>">Create New</a>
                        ...
                        foreach ($achievers as $key => $achiever) {
                            ...
                            <tr>
                                ...
                                <td><?php echo $achiever['created_at']; ?></td>
                                 <td>
                                  <a href="<?php echo base_url('Jarvis/Achievers/Delete/'.$achiever['id']);?>" target="_blank">Delete</a>/
                                </td>
                            </tr>
                            <?php
                            $i++;
