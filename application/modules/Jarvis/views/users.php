          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <form method="GET" action="<?php echo base_url('Jarvis/Management/users/');?>">
                <div class="row">
                    <div class="col-3">
                    ...
                    <div class="col-3">
                      <input type="text" name="value" class="form-control float-right" value="<?php if(empty($value)){ echo '';}else{ echo $value;}?>" placeholder="Search">
                    </div>
                        ...
                        foreach ($users as $key => $user) {
                            ...
                            <tr>
                                ...
                                <td><?php echo $user['single_leg_status']; ?></td>
                                 ...
                                 <td><?php echo number_format($user['income_wallet']['income_wallet'],2); ?></td> 
                                 <td><?php echo $user['created_at']; ?></td>
                                 <td><?php if($user['topup_date'] > 0){ echo $user['topup_date'];}else{ echo '<label class="badge badge-danger">Not Active</label>';} ?></td>
                                 <td><?php echo $user['withdraw_status'] == 1 ? 'Close' : 'Open'; ?></td>
                                 <td>
