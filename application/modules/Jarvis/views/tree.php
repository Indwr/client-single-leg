                ...
                <ul class="clearfix">
                    <li>
                        <div class="member-img">
                            <a href="<?php echo base_url('Jarvis/Management/Tree/' . $user['user_id']); ?>">
                        ...
                        <ul class="clearfix">
                            ...
                            foreach ($users as $key => $direct) {
                                ...
                                <li>
                                    <div class="member-img">
                                        <a href="<?php echo base_url('Jarvis/Management/Tree/' . $direct['user_id']); ?>">
                                    ...
                                    <ul class="clearfix">
                                        ...
                                        foreach ($direct['sub_directs'] as $k => $sub_direct) {
                                            ...
                                            <li>
                                                <div class="member-img">
                                                    <a href="<?php echo base_url('Jarvis/Management/Tree/' . $sub_direct['user_id']); ?>">
