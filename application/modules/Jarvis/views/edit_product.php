        ...
        <div class="col-md-8">
            <div class="kt-portlet kt-portlet--mobile">
                <div class="kt-portlet">
                    ...
                    <?php echo form_open(base_url('Jarvis/Package/EditProduct/' . $product['id'])); ?>
        ...
        <div class="col-md-4">
            ...
            foreach ($product_images as $key => $p_image) {
                ...
                <div class="img">
                    ...
                    <a href="<?php echo base_url('Jarvis/Package/delete_product_image/'.$product['id'].'/'.$p_image['id']);?>" onclick="return confirm('Are you sure?')">Delete</a>
                </div>
                <?php
            }
            ?>
...
<script type="text/javascript">
    ...
    $('.upload-result').on('click', function (ev) {
        $uploadCrop.croppie('result', {
            ...
            $.ajax({
                url: '<?php echo base_url('Jarvis/package/upload_product_image'); ?>',
                type: "POST",
                data: formData,
